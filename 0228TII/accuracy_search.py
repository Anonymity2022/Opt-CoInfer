...
parser.add_argument('-accuracy_or_latency', type=bool, default=True)
...
data_base_address='./database_stanford_cars.txt'
...
def gaussin_process(avaliable_evaluated_scheme):
    kernel = Matern(length_scale=[1,1,1],length_scale_bounds=[(1e-10,1e10),(1e-10,1e10),(1e-5,1e10)],nu=2.5)
...
if __name__ == "__main__":
    ...
    print(accuracy_or_latency_demand)
    if accuracy_or_latency_demand:
